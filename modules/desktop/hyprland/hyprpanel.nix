      ...
      settings = {
        menus = {
          clock = {
            time.military = true;
            weather.unit = "metric";
            weather.location = "Budapest";
          };
          media = {
            displayTime = true;
            noMediaText = "Enjoy the silence";
          };
          volume.raiseMaximumVolume = true;
          dashboard.shortcuts.right.shortcut3.command = "bash -c \"$HOME/.local/bin/screenshot.sh\"";
        };
        ...
        bar = {
          ...
          network.label = false;
          workspaces = {
            applicationIconEmptyWorkspace = "󰣈";
